            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 12) {
                    ItemDetailHeroCard(
                        ...
                        canOpenPrimaryContent: itemURL != nil || quickLookURL != nil,
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    DisclosureGroup(isExpanded: $artworkExpanded) {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Button {
                                    if SaviImageSearchService.isConfigured {
                                        ...
                                        iconLoadMessage = "Image search needs the SAVI image proxy to be configured."
                                    }
                                } label: {
                                ...
                                if folderImage != nil {
                                    Button {
                                        ...
                                        Label("Use symbol instead", systemImage: "square.grid.2x2.fill")
                                            .font(SaviType.ui(.caption, weight: .bold))
                                            .foregroundStyle(SaviTheme.accentText)
                                    }
                                    .buttonStyle(.plain)
                            ...
                            if folderImage != nil {
                                Toggle(isOn: $usesImageBackground) {
                                    VStack(alignment: .leading, spacing: 2) {
                                        Text("Use as card background")
                                            .font(SaviType.ui(.caption, weight: .bold))
                                            .foregroundStyle(SaviTheme.text)
                                        Text("SAVI adds a soft overlay so the folder name stays readable.")
                                            .font(SaviType.ui(.caption2, weight: .semibold))
                                            .foregroundStyle(SaviTheme.textMuted)
                                    }
                                }
                        ...
                        FolderEditorSectionLabel(
                            title: "Image",
                            subtitle: "Use a photo or stock-safe web image as the Folder art.",
                    ...
                    DisclosureGroup(isExpanded: $iconsExpanded) {
                        ...
                        FolderEditorSectionLabel(
                            title: "Symbol",
                            subtitle: "Pick the simple icon shown when no image is used.",
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 13) {
            ...
            VStack(alignment: .leading, spacing: 7) {
                ...
                HStack(spacing: 7) {
                    FolderEditorMiniChip(text: color.uppercased(), systemImage: "paintpalette.fill")
                    if locked {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 22, style: .continuous)
                .stroke(Color(hex: color).opacity(0.30), lineWidth: 1)
        )
